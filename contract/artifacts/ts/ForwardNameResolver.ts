...
export const ForwardNameResolver = new Factory(
  Contract.fromJson(
    ...
    "=82-7+e0=2+1=3-1=1+e=2-1+be45=1+4=1641-1+6=179-1+b=38+7a7e0214696e73657274206174206d617020706174683a2000=531-1+5=118+7a7e021472656d6f7665206174206d617020706174683a2000=22",
    "333d45105aee46bbdcca35dd811ef12a8a041548c0c81ad8430fdc81f16b2222",
    []
  )
);
